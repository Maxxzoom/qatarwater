...
export default function BrackishWaterROPage() {
  return (
        ...
        <section className="bg-[#1e40af] text-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Brackish Water Reverse Osmosis System</h1>
                <p className="text-xl text-[#0ea5e9] mb-8">
                  Specialized RO systems designed for brackish water treatment with optimized membranes and energy
                  efficiency.
                </p>
              ...
              <div className="relative">
                <Image
                  src="/brackish-water-ro-system-with-membrane-vessels-and.jpg"
                  alt="Brackish Water RO System"
                  width={600}
                  height={400}
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Low-pressure RO membranes</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>High recovery rates up to 85%</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Antiscalant dosing system</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="font-semibold">Operating Pressure:</span>
                      <span>150-300 PSI</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-semibold">Salt Rejection:</span>
                      <span>98-99%</span>
                    </div>
                    <div className="flex justify-between">
