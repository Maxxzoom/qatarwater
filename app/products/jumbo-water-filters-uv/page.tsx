...
export default function JumboWaterFiltersUVPage() {
  return (
        ...
        <section className="bg-[#1e40af] text-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Jumbo Water Filters With U.V. Sterilizer</h1>
                <p className="text-xl text-[#0ea5e9] mb-8">
                  Advanced jumbo filtration systems combined with UV sterilization technology for complete water
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Large capacity blue tanks with UV chamber</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Multi-stage filtration + UV sterilization</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>99.9% bacteria and virus elimination</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>High flow rate with complete disinfection</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>UV lamp life indicator</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="font-semibold">UV Dose:</span>
                      <span>30,000 µWs/cm²</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-semibold">Tank Size:</span>
                      <span>20" x 54" Blue Tanks</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-semibold">UV Lamp:</span>
                      <span>254nm Wavelength</span>
                    </div>
                    <div className="flex justify-between">
