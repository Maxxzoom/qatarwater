...
export default function WaterSoftenerCommercialPage() {
  return (
        ...
        <section className="bg-[#1e40af] text-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Water Softener For Commercial & Industrial</h1>
                <p className="text-xl text-[#0ea5e9] mb-8">
                  Heavy-duty commercial and industrial water softening systems designed for high-capacity applications
              ...
              <div className="relative">
                <Image
                  src="/large-commercial-water-softener-system-with-multip.jpg"
                  alt="Commercial Water Softener System"
                  width={600}
                  height={400}
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>High-capacity ion exchange resin</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Duplex and triplex configurations</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Continuous soft water supply</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
