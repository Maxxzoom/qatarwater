...
export default function HydroPneumaticSystemPage() {
  return (
        ...
        <section className="bg-[#1e40af] text-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Hydro Pneumatic System</h1>
                <p className="text-xl text-[#0ea5e9] mb-8">
                  Advanced pressure boosting systems that maintain consistent water pressure throughout buildings and
                  facilities.
                </p>
              ...
              <div className="relative">
                <Image
                  src="/hydro-pneumatic-water-pressure-system-with-pumps-a.jpg"
                  alt="Hydro Pneumatic System"
                  width={600}
                  height={400}
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Variable frequency drive pumps</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Pressure tank with bladder</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Automatic pressure control</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Multiple pump configurations</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span>10-500 GPM</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-semibold">Pressure:</span>
                      <span>30-150 PSI</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-semibold">Tank Size:</span>
                      <span>80-1000 Gallons</span>
                    </div>
                    <div className="flex justify-between">
