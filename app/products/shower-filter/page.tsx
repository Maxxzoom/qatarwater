...
export default function ShowerFilterPage() {
  return (
        ...
        <section className="bg-[#1e40af] text-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Shower Filter</h1>
                <p className="text-xl text-[#0ea5e9] mb-8">
                  Premium shower filtration systems that remove chlorine, heavy metals, and impurities for healthier
                  skin and hair.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Removes chlorine and chloramines</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>KDF and carbon filtration media</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Maintains water pressure</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Easy installation without tools</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Chrome-plated finish</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="font-semibold">Filter Life:</span>
