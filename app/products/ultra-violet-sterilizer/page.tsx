...
export default function UltraVioletSterilizerPage() {
  return (
        ...
        <section className="bg-[#1e40af] text-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Ultra Violet Sterilizer</h1>
                <p className="text-xl text-[#0ea5e9] mb-8">
                  Advanced UV sterilization systems using 254nm wavelength for effective disinfection of bacteria,
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>254nm germicidal UV lamps</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Stainless steel reactor chamber</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>99.99% pathogen inactivation</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>UV intensity monitoring</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Automatic lamp failure alarm</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="font-semibold">Lamp Life:</span>
                      <span>9000 Hours</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-semibold">Power:</span>
                      <span>15-320 Watts</span>
                    </div>
                    <div className="flex justify-between">
