...
export default function SeaWaterROPage() {
  return (
        ...
        <section className="bg-[#1e40af] text-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Sea Water Reverse Osmosis System</h1>
                <p className="text-xl text-[#0ea5e9] mb-8">
                  Industrial-grade seawater desalination systems designed to convert seawater into fresh, potable water
              ...
              <div className="relative">
                <Image
                  src="/industrial-water-treatment-facility-with-large-pip.jpg"
                  alt="Sea Water RO Treatment Facility"
                  width={600}
                  height={400}
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>High-pressure seawater RO membranes</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
