        ...
        <section className="bg-[#1e40af] text-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Jumbo Water Filters</h1>
                <p className="text-xl text-[#0ea5e9] mb-8">
                  High-capacity water filtration systems with large blue tanks for residential and commercial
                  applications, providing excellent water quality and flow rates.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Large capacity blue tanks for extended filtration</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Multi-stage sediment and carbon filtration</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>High flow rate for continuous water supply</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Easy maintenance and filter replacement</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>Sediment + Carbon</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-semibold">Inlet/Outlet:</span>
                      <span>1" to 2" Connections</span>
                    </div>
                    <div className="flex justify-between">
