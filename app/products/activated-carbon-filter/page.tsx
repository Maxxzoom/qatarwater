...
export default function ActivatedCarbonFilterPage() {
  return (
        ...
        <section className="bg-[#1e40af] text-white py-20">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Activated Carbon Filter</h1>
                <p className="text-xl text-[#0ea5e9] mb-8">
                  High-performance activated carbon filtration systems for chlorine, odor, and organic contaminant
                  removal.
                </p>
              ...
              <div className="relative">
                <Image
                  src="/activated-carbon-filter-system-with-granular-carbo.jpg"
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span>High-grade granular activated carbon</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Chlorine and chloramine removal</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Taste and odor improvement</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Organic contaminant adsorption</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#0ea5e9] rounded-full mt-2"></div>
                    <span>Automatic backwash capability</span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      <span className="font-semibold">Carbon Type:</span>
                      <span>Coconut Shell GAC</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      <span className="font-semibold">Media Life:</span>
